...
public class CommandReceiver {
    ...
    public String add(StudyGroup group) {return null;}
    public String addmin(StudyGroup group) {return null;}
    public String executeScript() {return null;}
    public String update(Long id, StudyGroup group) {return null;}
...
//    public String replaceIfGreater(int id, Product product) {return null;}
